...
import { Zap, CheckCircle, Loader2, Copy, Hash } from "lucide-react";
import { api } from "@/lib/api";

// Custom premium SVG brand icons (Lucide-compatible)
...
const platforms = [
  { id: "instagram", label: "Instagram", icon: InstagramIcon, color: "from-pink-500 to-orange-500" },
  { id: "linkedin", label: "LinkedIn", icon: LinkedinIcon, color: "from-blue-600 to-blue-800" },
  { id: "youtube", label: "YouTube", icon: YoutubeIcon, color: "from-red-500 to-red-700" },
];
